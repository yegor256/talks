...
\usepackage[nominutes,template,scheme=dark,nominutes]{ppt-slides}
\usepackage{clicks}
\usepackage{multicol}
...
\plick{
  \begin{textblock}{7}(4,7)
    ...
    \bi{6 programmers}{10 программистов}\par
...
\plush{
  \begin{textblock}{7}(10,4)
    ...
    \bi{1 Claude account}{1 Claude аккаунт}\par
    \bi{All part-time}{Все удаленно}\par
    \bi{\$108 monthly}{\$108 в месяц}\par
  \end{textblock}
  }
...
\citch{%
  \Huge\ttfamily%
  \href{https://github.com/yegor256/plugins}{yegor256/plugins}
  \par
  }
