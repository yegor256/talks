...
\lnQuote
  {nature}
  {The underlying concept of the computer hardware design that has remained fundamentally unchanged since the days of von Neumann is in need of serious reform.}
  {beyond2022}
