...
\lnPitch{
  \pptSection[C++]{Eventually, OOP Became a Real Deal}
  \begin{multicols}{2}
  ...
  \par\columnbreak\par
  \textbf{C++} was created by \hlt{enhancing} C language with SIMULA-like features. C was chosen because it was general-purpose, fast, portable and widely used.
  \end{multicols}}
