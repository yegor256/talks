...
\lnPitch{
  \pptSection{Why Me?}
  \begin{itemize}
  \item \href{https://www.yegor256.com/elegant-objects.html}{``Elegant Objects''} books: No.1 in \href{https://www.goodreads.com/shelf/show/object-oriented-programming}{Goodreads} OOP shelf
  \item \href{https://www.eolang.org}{EOLANG}, pure object-oriented language: 1.2K\(\star\)
  % \item \(\varphi\)-calculus, object modeling formalism
  \item \href{https://www.takes.org}{Takes}, Java Web Framework: 800\(\star\)
  \end{itemize}}
