...
\lnPitch{
  \begin{textblock}{8}[1,1](15,15)%
    ...
    {\color{gray}\fontsize{12}{12}\selectfont Image by \href{https://sora.chatgpt.com/g/gen_01k7xe5sppe8s984jq26grme12}{Sora} \par}
  \end{textblock}%
...
\lnPitch{\pptChapter[\rus{Помехи}{Threats}]{\rus{Что нам всегда мешает?}{What Are the Threats?}}}
...
\lnPitch{\pptSection[3.\rus{Грязь}{Dirt}]{3. \rus{Сложность, Дублирование и Smells}{Complexity, Duplication, and Smells}}}
