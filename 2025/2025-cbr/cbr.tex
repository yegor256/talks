...
"SELECT * FROM user WHERE name = (*@\textcolor{orange}{'" + name + "'"}@*)
\end{lnSnippet}
\lnPitch{
...
\lnPitch{\pptSection[1.\rus{Ревью}{Reviews}]{1. \rus{Ревью кода малыми порциями}{Reviews in Small Pull Requests}}}
...
\lnPitch{\pptSection[2.\rus{Тесты}{Tests}]{2. \rus{Контроль покрытия тестами}{Test Coverage Control}}}
...
\lnPitch{
  ...
  \href{https://github.com/asgeirtj/system_prompts_leaks}{asgeirtj/system_prompts_leaks}}
