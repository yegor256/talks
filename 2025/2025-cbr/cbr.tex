...
\lnPitch{\pptSection[1.Standards]{1. Write Up Quality Standards}}

\lnPitch{\pptSection[2.Architecture]{2. Explain the Architecture}}

\lnPitch{\pptSection[3.Tests]{3. Create More and Better Tests}}

\lnPitch{\pptSection[4.Reviews]{4. Practice Stricter Code Reviews}}
