...
\lnPitch{
  \pptSection[1.\rus{Качество}{Quality}]{1. \rus{Иллюзия качества}{False Sense of Quality}}
  \begin{textblock}{8}[1,1](14,14)%
    \raggedleft%
    \includegraphics[width=.4\linewidth]{gift.png}\\
    \bysora{01k8fhtfdxeevtfmyd48sk3ya0}
  \end{textblock}}
...
\lnPitch{
  \pptSection[2.\rus{Влияние}{Influence}]{2. \rus{Дурное влияние}{Bad Influence}}
  \begin{textblock}{8}[1,1](14,14)%
    \raggedleft%
    \includegraphics[width=.4\linewidth]{bad-guy.png}\\
    \bysora{01k8fjbj19fntae3sys45h7kg9}
  \end{textblock}}
...
\lnPitch{
  \pptSection[3.\rus{Утечки}{Leakage}]{\rus{3. Утечки данных}{3. Accidental Leakage of Data}}
  \begin{textblock}{8}[1,1](14,14)%
    \raggedleft%
    \includegraphics[width=.7\linewidth]{whisper.png}\\
    \bysora{01k8fnkwysee08zjzk3yzprh0x}
  \end{textblock}}
...
\lnPitch{
  \pptSection[4.\rus{Начальство}{Bosses}]{4. \rus{Давление менеджмента}{Management Pressure}}
  \begin{textblock}{8}[1,1](14,14)%
    \raggedleft%
    \includegraphics[width=.5\linewidth]{boss.png}\\
    \bysora{01k8fqdt0dfyg9y23wjnnb2w14}
  \end{textblock}}
...
\lnPitch{\pptChapter[Defense]{\rus{Как защищаться?}{How Can We Defend Ourselves?}}}
...
\lnPitch{
  ...
  \par\columnbreak\par
  \enquote{Both Android and AMD have a median change size of \ul{44 lines}. This median change size is larger than Apache, \ul{25 lines}, and Linux, \ul{32 lines}, but much smaller than Lucent where the number of non-comment lines changed is \ul{263 lines}. Bing, Chrome’s median change is \ul{78 lines} and includes 5 files.}
  \end{multicols}}
