...
\lnPitch{\pptSection[1.Reviews]{1. Better Code Reviews}}
...
\lnPitch{\pptSection[2.Tests]{2. More and Better Tests}}

\lnPitch{\pptSection[3.Standards]{3. Quality Standards}}
