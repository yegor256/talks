...
\newcommand*{\thetitle}{\rus{Враг у ворот: ИИ}{Enemy at the Gate: AI}}
\newcommand*{\thesubtitle}{\rus{Что нас защитит и как?}{What is the weapon to defend our code?}}
...
\lnPitch{
  \pptBanner{\rus{Наше оружие против ИИ}{Our Amunition Against LLM}:}
  \begin{enumerate}
...
\lnPitch{\pptSection[4.\rus{Стиль}{Style}]{4. \rus{Контроль стиля}{Style Checkers}}}
...
\lnPitch{
  ...
  \end{itemize}
  \par{\small\rus{Некоторые/большинство правил не только проверяют стиль, но и находят баги.}{Some/most of the rules no only check style, but also find bugs.}\par}}
...
\lnPitch{\pptSection[5.\rus{Архитектура}{Architecture}]{5. \rus{Описание архитектуры}{Written Architecture}}}

\begin{lnSnippet}[foo.java]
class Foo {
  int save_content(char* path) {
